...
{
    private const string DebugSymbol = "TRILIB_OUTPUT_MESSAGES";
    private const string DevilSymbol = "TRILIB_USE_DEVIL";
    private const string ZipSymbol = "TRILIB_USE_ZIP";
    private const string DebugEnabledMenuPath = "TriLib/Enable Debug";
    private const string DevilEnabledMenuPath = "TriLib/Enable DevIL Image Library (Windows only)";
    private const string ZipEnabledMenuPath = "TriLib/Enable Zip loading";
    #if UNITY_EDITOR_OSX && UNITY_IOS
	private const string IOSSimulatorSymbol = "TRILIB_USE_IOS_SIMULATOR";
...
#if USE_IOS_SIMULATOR || TRILIB_USE_IOS_SIMULATOR
