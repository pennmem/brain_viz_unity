    ...
    namespace Samples
    {
        ...
        public class AssetLoaderWindow : MonoBehaviour
        {
                ...
                #endif
                {
                        ...
                        using (var assetLoader = new AssetLoader())
                        {
                            ...
                            try
                            {
                                ...
                                assetLoader.LoadFromMemoryWithTextures(fileBytes, extension, null, out error, null, assetLoaderOptions, _rootGameObject);
                                #else
            ...
            private AssetLoaderOptions GetAssetLoaderOptions()
            {
                ...
                assetLoaderOptions.ApplyAlphaMaterials = false;
